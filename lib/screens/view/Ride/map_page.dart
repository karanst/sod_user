...
class MapPage extends StatefulWidget {
  ...
  bool live;
  String? id;
  MapPage(this.status,{ this.SOURCE_LOCATION, this.DEST_LOCATION,required this.live,this.id,this.pick="",this.dest="",this.carType,this.status1});
...
class MapPageState extends State<MapPage> with AutomaticKeepAliveClientMixin{
  ...
  String googleAPIKey = "AIzaSyBRnd5Bpqec-SYN-wAYFECRw3OHd4vkfSA";
  // for my custom icons
