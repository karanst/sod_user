...
class _ViewCartState extends State<ViewCart> {
  ...
  _getUserCart() async {
    ...
    if (response.statusCode == 200) {
      ...
      var finalResponse = await response.stream.bytesToString();
      final jsonResponse =
          GetUserCartModel.fromJson(json.decode(finalResponse));
                          ...
                          children: [
                            Text("Select Payment Method ",
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    color: backgroundblack)),
                            // Text("${payment}", style: TextStyle(fontSize: 16, color: backgroundblack, fontWeight: FontWeight.bold)),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              deliveryChargeDistanceModel?.total == null|| deliveryChargeDistanceModel?.total== ""? Text("Tota: ₹${getUserCartModel!.cartTotal ?? ""}",
                                style: TextStyle(
                                  fontSize: 15,
                                  color: backgroundblack,
                                  fontWeight: FontWeight.w500),):
                              ...
                              Text(
                                ...
                                "Total: ₹${deliveryChargeDistanceModel?.total}",
                                style: TextStyle(
                                    fontSize: 15,
                                    color: backgroundblack,
                                    fontWeight: FontWeight.w500),
                  ...
                  Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Text("Qty ${getUserCartModel!.cart![index].quantity}", style: TextStyle(color: backgroundblack,fontWeight: FontWeight.bold,fontSize: 14)),
                          Text("₹ ${getUserCartModel!.cart![index].qtyPrice}",
                              style: TextStyle(
                                  color: appColorBlack,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14)),
