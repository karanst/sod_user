...
class _DiscoverState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  confirmRideBook() async {
    ...
    if (response.statusCode == 200) {
      ...
      print("this is working respons e${jsonResponse['status']} ${jsonResponse['message'].toString()}");
          ...
          return InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => GroceryDetails(
                  id: foodCategoryModel!.product![index].id,
              name: foodCategoryModel!.product![index].storeName,)));
            },
            child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child:
                            Image.network("${foodCategoryModel!.product![index].profileImage}", height: 50, width: 50, fit: BoxFit.fill,)
                        ),
                        SizedBox(height: 5),
                        Column(
                          // crossAxisAlignment: CrossAxisAlignment.start,
        ...
        itemBuilder: (BuildContext context, int index) {
          return InkWell(
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => HandymanServices(h_id: handyManModel!.imgssss![index].id)));
            },
            child: Padding(
                padding: EdgeInsets.all(5),
                child: Card(
